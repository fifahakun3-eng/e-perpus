...
.cover-preview { display:flex; align-items:center; gap:12px; margin-bottom:10px; }
.cover-preview img { border-radius:6px; border:1px solid var(--border); }
.cover-preview span { font-size:12px; color:var(--text-muted); }

.section-divider { grid-column:1/-1; border:none; border-top:1px solid var(--warm-gray); margin:4px 0; }
...
<div class="pm-wrap">
  ...
  <div class="pm-header">
    <div class="pm-header-left">
      <h1>Edit Buku</h1>
      <p>Perbarui informasi koleksi buku</p>
    </div>
          ...
          <div class="form-group">
            ...
            <div class="tipe-toggle">
              <label class="tipe-opt">
                <input type="radio" name="tipe" value="fisik" {{ old('tipe', $buku->tipe ?? 'fisik') == 'fisik' ? 'checked' : '' }} required>
                <span>
              ...
              <label class="tipe-opt">
                <input type="radio" name="tipe" value="ebook" {{ old('tipe', $buku->tipe) == 'ebook' ? 'checked' : '' }}>
                <span>
        ...
        <div class="form-grid-3" style="margin-bottom:20px">
          ...
          <div class="form-group">
            ...
            <select name="rak" class="form-control @error('rak') is-invalid @enderror" required>
              ...
              @foreach (['A1', 'A2', 'B1', 'B2', 'C1'] as $r)
                <option value="{{ $r }}" {{ old('rak', $buku->rak) == $r ? 'selected' : '' }}>Rak {{ $r }}</option>
              @endforeach
            </select>
          ...
          <div class="form-group full" id="url-ebook-group" style="display:none">
            ...
            <input type="url" name="url_ebook" class="form-control @error('url_ebook') is-invalid @enderror"
              value="{{ old('url_ebook', $buku->url_ebook ?? '') }}" placeholder="https://drive.google.com/file/d/.../view">
          ...
          <div class="form-group full">
            ...
            @if ($buku->cover)
              <div class="cover-preview">
                <img src="{{ asset('storage/' . $buku->cover) }}" height="72" style="border-radius:6px; border:1px solid var(--border);">
                <span>Cover saat ini. Upload baru untuk mengganti.</span>
              </div>
            @endif
